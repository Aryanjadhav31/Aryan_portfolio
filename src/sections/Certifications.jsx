...
export default function Certifications() {
  const certs = [
    ...
    },
    {
      ...
      disambiguation: "certificate files",
      icon: ShieldCheck,
      live: "public/palo_alto cybersecurity_internship.pdf",
    },
    {
      ...
      disambiguation: "certificate files",
      icon: Coffee,
      live: "public/Coursera java p[rograming.pdf",
    },
    {
      ...
      disambiguation: "certificate files",
      icon: Cloud,
      live: "public/colud security zscaler.pdf",
    },
    {
      ...
      disambiguation: "certificate files",
      icon: Database,
      live: "public/DBMS_NPTEL_Certificate.pdf",
    },
  ];
